...
def compute_technical_skills_score(
    ...
    Uses Claude for semantic and inferred matching.
    Returns score 0-100.
    """
    if not job:
        return 50.0
...
def compute_assessment_score(
    ...
    if created_at and submitted_at:
        ...
        elapsed_minutes = (submitted_at - created_at).total_seconds() / 60
...
def compute_engagement_score(
    ...
    hours_elapsed = (submitted_at - sent_at).total_seconds() / 3600
